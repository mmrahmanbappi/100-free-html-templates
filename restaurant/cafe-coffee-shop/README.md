# Ember & Oat: Free Cafe and Coffee Shop Website Template (HTML)

A cosy neighbourhood cafe site. Build a drink by choosing type, size, milk and extras, and the cup and price update live. It also has a menu, a tappable loyalty stamp card and live open now hours.

![Ember & Oat, a free cafe and coffee shop website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/restaurant/cafe-coffee-shop/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with live open now badge
- Order-ahead drink builder with cup preview
- Coffee, bakery and brunch menu
- Photo strip
- Loyalty stamp card
...
- **Fonts:** Shrikhand + Karla, both free from Google Fonts.
- **Colours:** Coffee brown, peach, green. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/restaurant/cafe-coffee-shop/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: cafe website template, coffee shop HTML template free, cafe menu template, free HTML template, one page website template, responsive website template download</sub>

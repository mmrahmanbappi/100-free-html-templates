# The Green Lamp: Free Bar and Lounge Website Template (HTML)

A dark, art deco cocktail bar. The cocktail list filters by spirit and strength, a live clock counts down to happy hour, and the events calendar lets guests save a seat.

![The Green Lamp, a free bar and lounge website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/restaurant/bar-lounge/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Age notice bar
- Split hero with happy hour countdown
- Cocktail list with spirit and strength filters
- Photo strip
- Events calendar with save a seat
- Opening hours with today highlighted

## Fonts and colours

- **Fonts:** Limelight + Hanken Grotesk, both free from Google Fonts.
- **Colours:** Bottle green, peach, cream, berry red. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/restaurant/bar-lounge/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: bar website template, cocktail bar HTML template free, lounge website template, free HTML template, one page website template, responsive website template download</sub>

# Forno Rapido: Free Pizza Delivery Website Template (HTML)

A loud, hungry pizza delivery site. Build your own pizza and watch toppings appear on it, add menu pizzas to your order, and check the delivery time for your postcode.

![Forno Rapido, a free pizza delivery website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/restaurant/pizza-delivery/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with postcode delivery checker
- 3 deal cards
- Build-your-own pizza with live topping preview
- Size, crust and topping options with live price
- Pizza menu with add to order
- Slide-in order with totals
- Help FAQ

## Fonts and colours

- **Fonts:** Titan One + Rubik, both free from Google Fonts.
- **Colours:** Tomato red, cheese yellow, black. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/restaurant/pizza-delivery/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: pizza website template, pizza delivery HTML template free, pizzeria website template, free HTML template, one page website template, responsive website template download</sub>

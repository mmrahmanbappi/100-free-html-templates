# Long Table Catering: Free Catering Website Template (HTML)

A calm catering site in olive and fig. Pick a package, drag the guest slider and tick extras, and the price updates line by line, then drops straight into the quote form.

![Long Table Catering, a free catering website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/restaurant/catering/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Collage hero with key numbers
- Event types
- Per-guest price calculator with add-ons
...
- **Fonts:** Gilda Display + Rethink Sans, both free from Google Fonts.
- **Colours:** Olive green, fig, sage, charcoal. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/restaurant/catering/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: catering website template, catering HTML template free, event catering website template, free HTML template, one page website template, responsive website template download</sub>

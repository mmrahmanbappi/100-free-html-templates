# Crumb & Co: Free Bakery Website Template (HTML)

A sweet family bakery site. Today's bakes show stock left and sold-out labels, and the cake builder draws your cake as you pick size, flavour, icing and a message, with the price updating live.

![Crumb & Co, a free bakery website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/restaurant/bakery/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Today's bakes with stock left and sold out
- Custom cake builder with live drawing
...
- **Fonts:** Lora + Nunito Sans, both free from Google Fonts.
- **Colours:** Chocolate brown, caramel, soft pink. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/restaurant/bakery/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: bakery website template, bakery HTML template free, cake shop website, free HTML template, one page website template, responsive website template download</sub>

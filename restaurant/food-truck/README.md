# Cactus & Coal: Free Food Truck Website Template (HTML)

A bright taco truck site. The hero shows where the truck is parked today and if it's serving right now, the week strip shows every stop, and the event form works out a price as you type.

![Cactus & Coal, a free food truck website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/restaurant/food-truck/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with today's location and live serving status
- Weekly schedule with today highlighted
- Tap a day to see address and hours
- Menu with tabs
- Private event booking with price estimate
- FAQ

## Fonts and colours

- **Fonts:** Lilita One + Overpass, both free from Google Fonts.
- **Colours:** Turquoise, marigold, night navy. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/restaurant/food-truck/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: food truck website template, taco truck HTML template free, street food website template, free HTML template, one page website template, responsive website template download</sub>

# Osteria Lume: Free Restaurant Website Template (HTML)

A warm, candlelit restaurant site. The menu has section tabs and vegetarian and gluten-free filters, the hero shows if you're open right now, and the booking form has time slots with fully booked times crossed out.

![Osteria Lume, a free restaurant website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/restaurant/restaurant/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Full-screen photo hero with live open or closed status
- Menu with section tabs
- Vegetarian and gluten-free filters
- Chef story
- Opening hours with today highlighted
- Table booking with time slots and confirmation
- Reviews
- Location and contact

## Fonts and colours

- **Fonts:** DM Serif Display + Jost, both free from Google Fonts.
- **Colours:** Dark brown, gold, cream. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/restaurant/restaurant/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: restaurant website template, restaurant HTML template free, table booking website template, free HTML template, one page website template, responsive website template download</sub>

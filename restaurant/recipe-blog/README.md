# Salt & Stove: Free Recipe Blog Website Template (HTML)

A friendly home cook's recipe blog. Search and filter recipes, open one in cook mode, change the servings and watch every amount update, then tick off steps as you cook.

![Salt & Stove, a free recipe blog website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/restaurant/recipe-blog/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Recipe search
- Filters for quick, vegetarian, one pot and breakfast
- Recipe cards
- Servings scaler
- Cook mode step checklist with progress bar
- About the cook and newsletter

## Fonts and colours

- **Fonts:** Alegreya + Alegreya Sans, both free from Google Fonts.
- **Colours:** Kale green, mustard, white. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/restaurant/recipe-blog/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: recipe blog template, food blog HTML template free, recipe website template, free HTML template, one page website template, responsive website template download</sub>

# The Low Tides: Free Band and Musician Website Template (HTML)

A loud indie band site in ultraviolet and sunset orange. The album player runs through the track list, tour dates filter by region with sold out shows marked, and merch goes into a bag.

![The Low Tides, a free band and musician website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/events-community/musician-band/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Huge type hero
- Album player with track list (no audio files)
- Tour dates with region filter
- Merch with drawn products and bag
- Mailing list

## Fonts and colours

- **Fonts:** Dela Gothic One + Instrument Sans, both free from Google Fonts.
- **Colours:** Ultraviolet, sunset orange, pale pink. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/events-community/musician-band/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: band website template, musician HTML template free, music website template, free HTML template, one page website template, responsive website template download</sub>

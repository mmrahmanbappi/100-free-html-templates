# Clearwater Fund: Free Nonprofit and Charity Website Template (HTML)

A hopeful clean water charity in deep blue and sunshine yellow. Pick a monthly or one-time amount and see exactly what it pays for, watch the appeal bar move, and sign up to volunteer.

![Clearwater Fund, a free nonprofit and charity website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/events-community/nonprofit-charity/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Arched photo hero
- Impact numbers
- Donation picker with monthly and one-time amounts
- What your gift does, live
- Appeal progress bar
- Field stories
- Volunteer form with interests

## Fonts and colours

- **Fonts:** Spectral + Mukta, both free from Google Fonts.
- **Colours:** Deep water blue, sunshine yellow, sky. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/events-community/nonprofit-charity/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: charity website template, nonprofit HTML template free, donation website template, free HTML template, one page website template, responsive website template download</sub>

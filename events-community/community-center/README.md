# Maple Street Community Centre: Free Community Center Website Template (HTML)

A friendly neighbourhood centre in teal, maple red and yellow. It shows if the centre is open now, filters weekly activities by age, prices room hire with a community discount and lists events by month.

![Maple Street Community Centre, a free community center website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/events-community/community-center/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with open now badge
- Weekly programmes with age filter
- Room hire calculator with discount and extras
- Events calendar by month
- Find us

## Fonts and colours

- **Fonts:** Bitter + Kumbh Sans, both free from Google Fonts.
- **Colours:** Teal, maple red, yellow. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/events-community/community-center/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: community center website template, community centre HTML template free, village hall website, free HTML template, one page website template, responsive website template download</sub>

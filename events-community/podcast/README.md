# Second Draft: Free Podcast Website Template (HTML)

A bold podcast site in navy, orange and sand. Search and filter episodes, play any of them in the sticky player with skip and speed buttons, meet the hosts and copy the RSS link.

![Second Draft, a free podcast website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/events-community/podcast/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Big type hero
- Sticky player with skip and speed
- Episode list with search and topic filter
- Show more button
- Hosts and guests
- Listen anywhere with copy RSS link

## Fonts and colours

- **Fonts:** Anton + Radio Canada, both free from Google Fonts.
- **Colours:** Navy, orange, sand. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/events-community/podcast/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: podcast website template, podcast HTML template free, podcast landing page, free HTML template, one page website template, responsive website template download</sub>

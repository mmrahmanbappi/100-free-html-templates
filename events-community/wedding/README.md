# Amara & Theo: Free Wedding Website Template (HTML)

A romantic wedding site in eucalyptus and blush with a script heading. It counts down to the big day, tells the couple's story, and the RSVP asks each guest for their meal.

![Amara & Theo, a free wedding website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/events-community/wedding/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Arched photo hero with live countdown
- Our story timeline
- Photo trio
- Day schedule
- Travel and stay
- RSVP with meal choice per guest
- FAQ

## Fonts and colours

- **Fonts:** Pinyon Script + EB Garamond, both free from Google Fonts.
- **Colours:** Eucalyptus green, blush, ink. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/events-community/wedding/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: wedding website template, wedding RSVP HTML template free, save the date website template, free HTML template, one page website template, responsive website template download</sub>

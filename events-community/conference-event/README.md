# Buildwell Summit: Free Conference Website Template (HTML)

A bold tech conference site in midnight, magenta and mint. Filter speakers by track, star talks to build your own schedule, and pick ticket quantities with a running total.

![Buildwell Summit, a free conference website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/events-community/conference-event/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Big type hero with early bird countdown
- Speakers with track filter
- Two-day agenda with my schedule
- Ticket tiers with quantity and total
- Venue

## Fonts and colours

- **Fonts:** Familjen Grotesk, both free from Google Fonts.
- **Colours:** Midnight navy, magenta, mint. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/events-community/conference-event/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: conference website template, event HTML template free, tech conference website template, free HTML template, one page website template, responsive website template download</sub>

# Voltbay: Free Electronics Store Website Template (HTML)

A bright tech and gadget store template. It has a live deal countdown, sale banners, category tiles, product cards with ratings, working add to cart and a compare feature for up to three products.

![Voltbay, a free electronics store website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/ecommerce/electronics-store/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Top bar and search header
- Category menu
- Sale banner and two promo tiles
- Trust badges
- Deals of the day with live countdown
- Category tiles
- Best sellers with add to cart and compare
- Brand strip
- Help FAQ

## Fonts and colours

- **Fonts:** Titillium Web, both free from Google Fonts.
- **Colours:** Electric blue, yellow, black. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/ecommerce/electronics-store/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: electronics store website template, gadget shop HTML template free, tech store ecommerce template, free HTML template, one page website template, responsive website template download</sub>

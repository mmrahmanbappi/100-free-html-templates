# Freshcart: Free Grocery Store Website Template (HTML)

A cheerful online grocery store. Products can be added with + and − buttons, the basket shows totals and how much more is needed for free delivery, and customers can pick a delivery time slot.

![Freshcart, a free grocery store website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/ecommerce/grocery-store/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Header with search, delivery slot and basket total
- Aisle menu
- Hero banner and offer tiles
- Delivery perks
- Shop by aisle
- Products with + and − quantity buttons
- Slide-in basket with minimum order message
- Delivery time slot picker
- FAQ

## Fonts and colours

- **Fonts:** Fredoka + Nunito, both free from Google Fonts.
- **Colours:** Leaf green, sunny yellow, orange. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/ecommerce/grocery-store/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: grocery store website template, online grocery HTML template free, supermarket website template, free HTML template, one page website template, responsive website template download</sub>

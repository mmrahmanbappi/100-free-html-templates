# Everbottle: Free Single Product Store Website Template (HTML)

A full product page for a one-product brand. It has a photo gallery, colour swatches that change the product photo, size buttons that change the price, a quantity picker, a sticky buy bar, a savings calculator, reviews and FAQ.

![Everbottle, a free single product store website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/ecommerce/single-product-store/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Colour swatches and size picker
- Quantity and add to cart with confirmation
- Delivery, trial and warranty notes
- Feature numbers and comparison bars
- Savings calculator with slider
- Review score breakdown and reviews
- FAQ
- Sticky buy bar on scroll

## Fonts and colours

- **Fonts:** Albert Sans, both free from Google Fonts.
- **Colours:** Sage green, forest green, sun yellow. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/ecommerce/single-product-store/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: single product website template, one product store template free, product landing page HTML, free HTML template, one page website template, responsive website template download</sub>

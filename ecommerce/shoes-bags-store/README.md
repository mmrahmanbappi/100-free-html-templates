# Stride: Free Shoes and Bags Store Website Template (HTML)

A bold, sporty shoe and bag shop. Filter shoes or bags, pick an EU size on each product (sold-out sizes are crossed out) before adding to cart, with a full size conversion chart.

![Stride, a free shoes and bags store website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/ecommerce/shoes-bags-store/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Coral split hero
- Scrolling perks ticker
- Product grid with shoes and bags filter
- Size picker with sold-out sizes
- Size conversion chart (EU, UK, US)
- Bags feature section
- Help FAQ

## Fonts and colours

- **Fonts:** Archivo Black + Archivo, both free from Google Fonts.
- **Colours:** Coral red, black, light grey. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/ecommerce/shoes-bags-store/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: shoe store website template, bag shop HTML template free, footwear ecommerce template, free HTML template, one page website template, responsive website template download</sub>

# Aurelle: Free Jewellery Store Website Template (HTML)

A refined fine-jewellery store in emerald and champagne. Filter by metal, add to bag, and try the live engraving preview: type a message and pick a metal to see it on the ring.

![Aurelle, a free jewellery store website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/ecommerce/jewellery-store/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Split hero with product photo
- Trust points
- Collection with metal filters
- Live ring engraving preview with metal and size
- Gift wrap option with price update
...
- **Fonts:** Marcellus + Lato, both free from Google Fonts.
- **Colours:** Emerald green, champagne gold. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/ecommerce/jewellery-store/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: jewellery store website template, jewelry shop HTML template free, luxury ecommerce template, free HTML template, one page website template, responsive website template download</sub>

# Dewline: Free Skincare and Cosmetics Store Website Template (HTML)

A soft, calm skincare brand store. A working 3-question skin quiz suggests a personal routine you can add to the bag in one click, plus bestsellers, key ingredients, brand story, reviews and FAQ.

![Dewline, a free skincare and cosmetics store website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/ecommerce/cosmetics-skincare-store/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Promo bar
- Hero with arched product photo
- 3-question skin quiz with personal routine
- Bestsellers with add to bag
- Key ingredients and free-from list
- Brand story
- Reviews
- FAQ
...
- **Fonts:** Cormorant Garamond + Nunito Sans, both free from Google Fonts.
- **Colours:** Pistachio, forest green, rose. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/ecommerce/cosmetics-skincare-store/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: skincare website template, cosmetics store HTML template free, beauty ecommerce template, free HTML template, one page website template, responsive website template download</sub>

# Terra & Thread: Free Handicraft Store Website Template (HTML)

A warm marketplace for handmade pottery, weaving and woodwork. Filter by craft, meet the makers, see how made-to-order works and build a gift card with a live preview.
...
- Hero with arched photo collage
- Maker numbers
- Products with craft filters
- Maker profiles
- 4-step made-to-order process
- Gift card picker with live preview
- Reviews
- FAQ

## Fonts and colours

- **Fonts:** Libre Baskerville + Karla, both free from Google Fonts.
- **Colours:** Clay, indigo, bone white. You can change every colour in the `:root` section at the top of the `<style>` block.
...
<sub>Search terms: handicraft store website template, handmade shop HTML template free, pottery store template, free HTML template, one page website template, responsive website template download</sub>

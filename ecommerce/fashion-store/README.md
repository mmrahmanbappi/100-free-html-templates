# Maison Vera: Free Fashion Store Website Template (HTML)

An elegant clothing boutique template. Products can be filtered by category and added to a working shopping bag that slides in, with quantities, subtotal and a free delivery progress bar at the top.

![Maison Vera, a free fashion store website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/ecommerce/fashion-store/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Store perks
- Product grid with category filters and add to bag
- Slide-in shopping bag with quantities and subtotal
- Lookbook banner
- Collections
- Reviews
- Newsletter signup
...
- **Fonts:** Italiana + DM Sans, both free from Google Fonts.
- **Colours:** Espresso brown, sand, wine red. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/ecommerce/fashion-store/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: fashion store website template, clothing store HTML template free, online boutique template, free HTML template, one page website template, responsive website template download</sub>

# Halvorsen: Free Architect Portfolio Website Template (HTML)

A calm, minimal site for an architect or architecture studio. The project list can be filtered and shows a large photo preview when you hover a project, with studio numbers, services and awards.

![Halvorsen, a free architect portfolio website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/portfolio/architect-portfolio/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Large type hero with studio numbers
- Full-width project photo
- Project list with filters and hover preview
- 4 services
- Awards list
...
- **Fonts:** Epilogue, both free from Google Fonts.
- **Colours:** Concrete grey, black, rust. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/portfolio/architect-portfolio/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: architect portfolio template, architecture firm website HTML free, architecture studio template, free HTML template, one page website template, responsive website template download</sub>

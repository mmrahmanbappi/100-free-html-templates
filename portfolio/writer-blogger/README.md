# Clara Voss: Free Writer and Blogger Website Template (HTML)

A calm, readable blog and writer site. It has a featured story, an article list with working search and topic filters, a newsletter box, an author bio and a books section.

![Clara Voss, a free writer and blogger website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/portfolio/writer-blogger/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- **Fonts:** Literata + Karla, both free from Google Fonts.
- **Colours:** Ink brown, paper white, brick red. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/portfolio/writer-blogger/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: blog website template, writer portfolio HTML free, author website template, free HTML template, one page website template, responsive website template download</sub>

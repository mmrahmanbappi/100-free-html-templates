# Lena Park: Free Designer Portfolio Website Template (HTML)

A bright, friendly portfolio for a UX, UI or product designer. Colourful case study cards show the problem and the result, with a 4-step process, tools, a client quote and a contact form with tick-box options.

![Lena Park, a free designer portfolio website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/portfolio/designer-portfolio/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Big headline intro with photo
- Client logos
- 4 colourful case study cards with results
- 4-step design process
- Tools list
- Client quote
- Contact form with tick-box needs

## Fonts and colours

- **Fonts:** Gloock + Manrope, both free from Google Fonts.
- **Colours:** Peach, lilac, mint, sun yellow. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/portfolio/designer-portfolio/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: designer portfolio template, UX designer portfolio HTML free, product designer portfolio website, free HTML template, one page website template, responsive website template download</sub>

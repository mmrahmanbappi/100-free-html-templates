# Aisha Rahman: Free Resume and CV Website Template (HTML)

A tidy online CV that looks right on screen and on paper. One click prints it or saves it as a PDF, with the menu hidden. Includes skills bars, languages, certificates, work history, education and references.

![Aisha Rahman, a free resume and cv website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/portfolio/resume-cv/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Top bar with print or save as PDF button
- Sidebar with photo, contact, skills and languages
...
- **Fonts:** Source Serif 4 + Public Sans, both free from Google Fonts.
- **Colours:** Navy, copper, soft blue. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/portfolio/resume-cv/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: resume website template, online CV HTML template free, printable resume template, free HTML template, one page website template, responsive website template download</sub>

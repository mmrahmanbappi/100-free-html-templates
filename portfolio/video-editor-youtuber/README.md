# Kai Frame: Free Video Editor Portfolio Website Template (HTML)

A dark, punchy site for a video editor, YouTuber or content creator. It has a showreel, channel stats, a filterable video grid that opens a player pop-up for your embed, services with prices and gear.

![Kai Frame, a free video editor portfolio website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/portfolio/video-editor-youtuber/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Big headline hero with showreel
- Channel stats
- Video grid with filters and player pop-up
...
- **Fonts:** Bebas Neue + Barlow, both free from Google Fonts.
- **Colours:** Near-black, bright orange. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/portfolio/video-editor-youtuber/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: video editor portfolio template, YouTuber website template free, content creator portfolio HTML, free HTML template, one page website template, responsive website template download</sub>

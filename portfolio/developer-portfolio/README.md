# Maya Okafor: Free Developer Portfolio Website Template (HTML)

A clean developer portfolio with a terminal-style intro. Projects can be filtered by technology, a GitHub-style activity chart shows a year of work, plus skills with years, work history and a copy email button.

![Maya Okafor, a free developer portfolio website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/portfolio/developer-portfolio/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Projects with technology filters
- Yearly coding activity chart
- Skills with years of experience
- Work history timeline
- Contact box with copy email button

## Fonts and colours

- **Fonts:** Fira Code + Figtree, both free from Google Fonts.
- **Colours:** Near-black, teal, off-white. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/portfolio/developer-portfolio/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: developer portfolio template, programmer portfolio HTML free, software engineer portfolio website, free HTML template, one page website template, responsive website template download</sub>

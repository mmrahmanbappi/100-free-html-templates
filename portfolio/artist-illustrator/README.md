# Mira Solis: Free Artist Portfolio Website Template (HTML)

A bright, playful portfolio for an artist or illustrator. The artwork gallery opens a viewer, prints can be bought in three sizes with live prices, and the commission form shows a starting price.

![Mira Solis, a free artist portfolio website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/portfolio/artist-illustrator/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with tilted artwork stack
- Artwork gallery with viewer
- Print shop with size picker and cart
- 4-step commission process
- Commission form with starting price
- FAQ

## Fonts and colours

- **Fonts:** Caprasimo + Figtree, both free from Google Fonts.
- **Colours:** Indigo, pink, sunshine yellow. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/portfolio/artist-illustrator/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: artist portfolio template, illustrator website HTML free, art print shop template, free HTML template, one page website template, responsive website template download</sub>

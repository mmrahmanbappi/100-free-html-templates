# Nils Aurora: Free Photographer Portfolio Website Template (HTML)

A dark, full-screen photography portfolio. The masonry gallery can be filtered and opens a full-screen lightbox with next and previous buttons and keyboard arrows, plus packages and a booking form.

![Nils Aurora, a free photographer portfolio website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/portfolio/photographer-portfolio/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Full-screen lightbox with arrows
- About and awards
- 3 photography packages
- Client quote
- Booking form with date

## Fonts and colours

- **Fonts:** Tenor Sans + Figtree, both free from Google Fonts.
- **Colours:** Black, bone white. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/portfolio/photographer-portfolio/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: photographer portfolio template, photography website HTML free, photo gallery website template, free HTML template, one page website template, responsive website template download</sub>

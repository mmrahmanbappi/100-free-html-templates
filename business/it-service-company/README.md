# Northstack: Free IT Service Company Website Template (HTML)

A dark, modern website for an IT support or tech company. It shows your services, response times, the industries you work with, prices and a booking form.

![Northstack, a free it service company website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/business/it-service-company/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with live uptime console
- Client logo strip
- 6 service cards
- SLA and guarantees band
- Industries served
- Technology stack
...
- **Fonts:** Unbounded + Figtree, both free from Google Fonts.
- **Colours:** Dark petrol, signal orange, ice blue. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/business/it-service-company/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: IT company website template, managed IT services template, cybersecurity company HTML, free HTML template, one page website template, responsive website template download</sub>

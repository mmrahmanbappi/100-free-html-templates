# Loop Social: Free Social Media Marketing Agency Website Template (HTML)

A fun, colourful website for a social media manager or agency. It has a phone mockup of a client profile, services, a follower growth chart, content samples, monthly plans and a free content plan form.

![Loop Social, a free social media marketing agency website template](screenshot.png)

**[See the live demo](https://mmrahmanbappi.github.io/free-html-templates/business/social-media-marketing/)** &nbsp;|&nbsp; **[Download ZIP](https://github.com/mmrahmanbappi/free-html-templates/archive/refs/heads/main.zip)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/free-html-templates/)
...
- Hero with phone profile mockup
- Platforms strip
- 6 service cards
- Follower growth chart and results
- Content samples grid
- 4-step process
- 3 monthly plans
- Client review
- FAQ
- Free content plan form

## Fonts and colours

- **Fonts:** Lexend + Karla, both free from Google Fonts.
- **Colours:** Deep grape, tangerine, peach, lilac. You can change every colour in the `:root` section at the top of the `<style>` block.
...
<sub>Search terms: social media marketing agency template, social media manager website template free, SMM agency HTML template, free HTML template, one page website template, responsive website template download</sub>

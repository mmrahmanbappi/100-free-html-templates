# Codefield: Free Web Development Agency Website Template (HTML)

A clean, sharp website for a web design and development company. It shows your services with starting prices, Google speed scores, recent websites, a 5-step process, packages and a quote form.

![Codefield, a free web development agency website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/business/web-development-agency/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with code window and website preview
- Technology strip
- 6 services with starting prices
- Google speed score rings
- Portfolio with results
- 5-step process with timings
...
- **Fonts:** Archivo + Source Sans 3 + JetBrains Mono, both free from Google Fonts.
- **Colours:** Ink navy, teal, lemon yellow. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/business/web-development-agency/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: web development agency template, web design company website template free, web agency HTML template, free HTML template, one page website template, responsive website template download</sub>

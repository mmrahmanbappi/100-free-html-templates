# Tandem: Free Freelancer Team Website Template (HTML)

A warm, people-first website for a group of freelancers or a small collective. It shows each person with skills, hourly rate and availability, plus projects, a price comparison table and a brief form.

![Tandem, a free freelancer team website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/business/freelancer-team/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with availability badge and photo collage
- Key numbers bar
- 6 freelancer profile cards with rates and status
- Recent projects
- 3-step hiring process
- Comparison table vs agency and single freelancer
- Client quote
- FAQ
- Project brief form
...
- **Fonts:** Epilogue + Mulish, both free from Google Fonts.
- **Colours:** Charcoal blue, mustard yellow, soft white. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/business/freelancer-team/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: freelancer website template, freelance team website template free, freelancer collective HTML template, free HTML template, one page website template, responsive website template download</sub>

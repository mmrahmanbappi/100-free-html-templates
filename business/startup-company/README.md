# Fernway: Free Startup Company Website Template (HTML)

A friendly, colourful website for a tech or app startup. It has a signup box, feature tiles, how it works, growth numbers, reviews, founders, a hiring banner and FAQ.

![Fernway, a free startup company website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/business/startup-company/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with email signup and app photo
- Investor strip
- Colourful feature tiles
- 3-step how it works
- Growth numbers and funding
- Customer reviews
- Founders and hiring banner
- FAQ
- Final signup section

## Fonts and colours

- **Fonts:** Gabarito + Nunito Sans, both free from Google Fonts.
- **Colours:** Navy, mint, pink, butter yellow. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/business/startup-company/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: startup website template, startup landing page template free, app landing page HTML template, free HTML template, one page website template, responsive website template download</sub>

# Meridian Group: Free Corporate Company Website Template (HTML)

A calm, professional website for a large company or business group. It has a company profile, business divisions, history, leadership, news and a careers section.

![Meridian Group, a free corporate company website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/business/corporate-company/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Full-width hero with key facts bar
- About section with CEO sign-off
- Business divisions grid
- Company history timeline
- Leadership team
- Sustainability goals with progress bars
- News and investor updates
- Careers banner
- Office contacts

## Fonts and colours

- **Fonts:** Newsreader + Public Sans, both free from Google Fonts.
- **Colours:** Slate navy, steel grey, brass. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/business/corporate-company/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: corporate website template, company profile HTML template, business group website, free HTML template, one page website template, responsive website template download</sub>

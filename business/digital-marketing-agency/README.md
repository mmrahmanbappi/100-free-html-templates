# Brightline: Free Digital Marketing Agency Website Template (HTML)

A bright, bold website for a marketing agency. It shows your services, past results, prices and team, and has a form so clients can book a free call.

![Brightline, a free digital marketing agency website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/business/digital-marketing-agency/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with photo collage and results badge
- Animated results ticker
- Services grid (SEO, paid ads, social, content, email)
- Case studies with real-style metrics
- 4-step process
- Team section
- Testimonials
- 3-tier pricing
...
- **Fonts:** Bricolage Grotesque + DM Sans, both free from Google Fonts.
- **Colours:** Deep teal, magenta, sunflower yellow. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/business/digital-marketing-agency/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: digital marketing agency template, SEO agency website, marketing agency HTML template, free HTML template, one page website template, responsive website template download</sub>

# Studio Kiln: Free Creative Agency Website Template (HTML)

A bold, big-type website for a design studio or branding agency. It shows your best projects, services, awards and team, with a project form that lets clients pick what they need.

![Studio Kiln, a free creative agency website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/business/creative-agency/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Giant headline hero with image strip
- Client strip
- Portfolio grid with 4 projects
- Services list
- Big client quote
- Awards table
- Studio team
- Project form with tick-box options

## Fonts and colours

- **Fonts:** Syne + Manrope, both free from Google Fonts.
- **Colours:** Cobalt blue, soft pink, deep navy. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/business/creative-agency/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: creative agency website template, design studio website template free, branding agency HTML template, free HTML template, one page website template, responsive website template download</sub>

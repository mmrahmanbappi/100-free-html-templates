# Forge Code School: Free Coding Bootcamp Website Template (HTML)

A blueprint-style coding school. Code types itself in the hero, each track has a week by week syllabus, outcomes show as a bar chart, and the application has 3 steps.

![Forge Code School, a free coding bootcamp website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/education/coding-bootcamp/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Blueprint hero with typing code editor
- Course tracks with tabs
- Week by week syllabus
- Graduate outcome numbers and bar chart
- 3-step application form with checks

## Fonts and colours

- **Fonts:** Anybody + Fragment Mono, both free from Google Fonts.
- **Colours:** Blueprint blue, yellow, white. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/education/coding-bootcamp/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: coding bootcamp website template, coding school HTML template free, programming course website template, free HTML template, one page website template, responsive website template download</sub>

# Write It Plain: Free Online Course Website Template (HTML)

A course sales page styled like an editor's desk, with red pen edits in the hero. The curriculum opens module by module, the preview lesson plays, and team seat prices update.

![Write It Plain, a free online course website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/education/online-course/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with editing marks and lesson preview player
- Course facts strip
- Curriculum accordion with open all
- Instructor bio
- Pricing with team seat counter
- Reviews with star filter
- FAQ

## Fonts and colours

- **Fonts:** Libre Caslon Text + Sen, both free from Google Fonts.
- **Colours:** Prussian blue, ochre, red pen, pale blue. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/education/online-course/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: online course website template, course landing page HTML template free, e-course sales page template, free HTML template, one page website template, responsive website template download</sub>

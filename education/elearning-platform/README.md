# Studyloop: Free E-learning Platform Website Template (HTML)

A bright e-learning platform in grape and lemon. Search, filter and sort the course catalogue, and every course you enrol in shows up in the learner dashboard in the hero.

![Studyloop, a free e-learning platform website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/education/elearning-platform/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with learner dashboard preview
- Course catalogue with search, level, price and sort
- Category chips
- Enrol buttons that update the dashboard
- Learn on any screen
- Free and Plus plans

## Fonts and colours

- **Fonts:** Funnel Display + Funnel Sans, both free from Google Fonts.
- **Colours:** Grape purple, lemon, lavender. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/education/elearning-platform/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: elearning website template, online learning platform HTML template free, LMS website template, free HTML template, one page website template, responsive website template download</sub>

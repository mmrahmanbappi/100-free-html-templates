# Little Acorns: Free Kids Daycare Website Template (HTML)

A soft, playful daycare site in acorn brown, leaf green and sunshine. The daily routine highlights what's happening right now, and each age group shows ratios and fees.

![Little Acorns, a free kids daycare website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/education/kids-daycare/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with rounded photo collage
- Daily routine timeline with live now marker
- Age groups with fees
- Safety promises
- Visit booking with time slots

## Fonts and colours

- **Fonts:** Grandstander + Quicksand, both free from Google Fonts.
- **Colours:** Acorn brown, leaf green, sunshine, sky blue. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/education/kids-daycare/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: daycare website template, nursery HTML template free, preschool website template, free HTML template, one page website template, responsive website template download</sub>

# Northgate University: Free University Website Template (HTML)

A classic university site in deep green and copper. Search from the hero, then filter courses by level, subject and study mode and add them to a shortlist.

![Northgate University, a free university website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/education/university/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Full-bleed campus hero with course search
- Key numbers
- Course finder with filters and shortlist
- Campus life photo grid
- How to apply steps
- Open day call to action

## Fonts and colours

- **Fonts:** Crimson Pro + Readex Pro, both free from Google Fonts.
- **Colours:** Deep green, copper, pale sage. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/education/university/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: university website template, college HTML template free, course finder template, free HTML template, one page website template, responsive website template download</sub>

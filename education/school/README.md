# Hollybrook Primary: Free School Website Template (HTML)

A warm primary school site in maroon and gold. The notice board counts down to the next holiday, news filters by topic, and the term dates table highlights the next break.

![Hollybrook Primary, a free school website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/education/school/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with notice board and holiday countdown
- School news with category filter
- Upcoming events
- Admissions steps
- Term dates table with next holiday highlighted
- Visit and contact

## Fonts and colours

- **Fonts:** Baloo 2 + PT Sans, both free from Google Fonts.
- **Colours:** Maroon, gold, sky blue. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/education/school/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: school website template, primary school HTML template free, academy website template, free HTML template, one page website template, responsive website template download</sub>

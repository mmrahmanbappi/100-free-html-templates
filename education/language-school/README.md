# Chatterbox: Free Language School Website Template (HTML)

A colourful language school with speech bubbles in the hero. Pick a language, answer six quick questions to find your level, then filter the timetable and hold a seat.

![Chatterbox, a free language school website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/education/language-school/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Speech bubble hero
- Language picker
- Level quiz with live result
- Course timetable with level filter and seat holding
- Prices
- Photo strip

## Fonts and colours

- **Fonts:** Righteous + Hind, both free from Google Fonts.
- **Colours:** Green, sunshine yellow, rose, ink. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/education/language-school/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: language school website template, language course HTML template free, language academy website template, free HTML template, one page website template, responsive website template download</sub>

# Keystone Realty: Free Real Estate Agency Website Template (HTML)

A calm, trustworthy estate agency in teal and gold. Switch between buy and rent, filter homes by area, bedrooms and price, save favourites, and work out a monthly mortgage payment.

![Keystone Realty, a free real estate agency website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/free-html-templates/real-estate-travel/real-estate-agency/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/free-html-templates/)
...
- Full-bleed photo hero with property search
- Buy or rent toggle
- Listing cards with favourites
- Saved only filter
- Mortgage calculator with payment split
- Agents
- Sell your home call to action

## Fonts and colours

- **Fonts:** Prata + Heebo, both free from Google Fonts.
- **Colours:** Teal, gold, slate. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/free-html-templates/real-estate-travel/real-estate-agency/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: real estate website template, realtor HTML template free, estate agent website template, free HTML template, one page website template, responsive website template download</sub>

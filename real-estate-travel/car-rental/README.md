# Wayfare Car Hire: Free Car Rental Website Template (HTML)

A bold car hire site in red and graphite with a drawn car on the road. Filter cars by type, gearbox and seats, pick one, add extras, and the total updates for your dates.

![Wayfare Car Hire, a free car rental website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/real-estate-travel/car-rental/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with drawn car and date search
- Car filters
- Car list with daily and total prices
- Weekly discounts
- Booking summary with extras
- Why us
- Photo band

## Fonts and colours

- **Fonts:** Saira Condensed + Saira, both free from Google Fonts.
- **Colours:** Red, graphite, light grey. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/real-estate-travel/car-rental/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: car rental website template, car hire HTML template free, rent a car template, free HTML template, one page website template, responsive website template download</sub>

# Fernhollow Cabin: Free Vacation Rental Website Template (HTML)

A cosy single cabin page in pine and lake blue. Pick check-in and check-out on the availability calendar, booked nights are crossed out, and the price splits weeknights, weekends and fees.

![Fernhollow Cabin, a free vacation rental website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/real-estate-travel/vacation-rental/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- House rules
- Host
- Availability calendar with date range
- Price breakdown
- The area

## Fonts and colours

- **Fonts:** Zilla Slab + Cabin, both free from Google Fonts.
- **Colours:** Pine green, lake blue, warm wood. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/real-estate-travel/vacation-rental/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: vacation rental website template, cabin rental HTML template free, holiday home website template, free HTML template, one page website template, responsive website template download</sub>

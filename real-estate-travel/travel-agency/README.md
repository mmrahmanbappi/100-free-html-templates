# Far & Wide Trips: Free Travel Agency Website Template (HTML)

A bright travel agency with a photo collage hero. Filter trips by region, length and budget, open a sample itinerary day by day, and see an estimated cost in the enquiry form.

![Far & Wide Trips, a free travel agency website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/real-estate-travel/travel-agency/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Photo collage hero
- Trip cards with region, length and budget filters
- Day by day itinerary tabs
- Enquiry form with trip cost estimate

## Fonts and colours

- **Fonts:** Bungee + Hind Madurai, both free from Google Fonts.
- **Colours:** Lagoon teal, hibiscus pink, sand. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/real-estate-travel/travel-agency/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: travel agency website template, tour operator HTML template free, holiday packages website template, free HTML template, one page website template, responsive website template download</sub>

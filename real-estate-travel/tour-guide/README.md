# Ridge & River Tours: Free Tour Guide Website Template (HTML)

A rugged hiking tour company in heather and moss. Filter tours by length, change the group size to see the price per person drop, and pick a date on a live month calendar.

![Ridge & River Tours, a free tour guide website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/real-estate-travel/tour-guide/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Big type photo hero
- Key facts band
- Tour list with length filter
- Group size price calculator
- Availability calendar with booking form
- Reviews

## Fonts and colours

- **Fonts:** Staatliches + Signika, both free from Google Fonts.
- **Colours:** Heather purple, moss green, mist. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/real-estate-travel/tour-guide/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: tour guide website template, tour company HTML template free, hiking tours website template, free HTML template, one page website template, responsive website template download</sub>

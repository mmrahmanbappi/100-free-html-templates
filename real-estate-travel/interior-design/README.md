# Hollow & Hue: Free Interior Design Website Template (HTML)

A soft, grown-up interior design studio in moss and plaster pink. The portfolio filters by room, and a three-question style quiz shows your look with a matching palette.

![Hollow & Hue, a free interior design website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/real-estate-travel/interior-design/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Split hero with arch badge
- Portfolio with room filter
- Style quiz with live result and palette
- Services with fixed fees
- Enquiry form

## Fonts and colours

- **Fonts:** Poiret One + Questrial, both free from Google Fonts.
- **Colours:** Moss green, plaster pink, charcoal. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/real-estate-travel/interior-design/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: interior design website template, interior designer HTML template free, interior portfolio template, free HTML template, one page website template, responsive website template download</sub>

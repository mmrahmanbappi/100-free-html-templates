# Casa Palmera: Free Hotel and Resort Website Template (HTML)

A relaxed coastal resort in ocean blue and sand. Pick dates and guests in the hero, and every room shows the total for your stay, hides rooms too small for your group and builds a booking summary.

![Casa Palmera, a free hotel and resort website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/real-estate-travel/hotel-resort/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Full-bleed hero with date and guest picker
- Intro with photos
- Rooms with nightly and total prices
- Booking summary
- Amenities
- Photo gallery
...
- **Fonts:** Cinzel + Montserrat, both free from Google Fonts.
- **Colours:** Ocean blue, sand gold, white. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/real-estate-travel/hotel-resort/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: hotel website template, resort HTML template free, hotel booking website template, free HTML template, one page website template, responsive website template download</sub>

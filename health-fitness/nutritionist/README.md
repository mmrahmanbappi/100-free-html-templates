# Leaf & Ladle: Free Nutritionist Website Template (HTML)

A fresh, friendly dietitian site in beet and leaf green. Meal plan prices change as you pick 4, 8 or 12 weeks, and the water calculator fills up glasses as you type.

![Leaf & Ladle, a free nutritionist website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/health-fitness/nutritionist/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with round plate photo
- Services
- Meal plan packages with length toggle and savings
- Water intake calculator with glass counter
- Consult booking form

## Fonts and colours

- **Fonts:** Petrona + Golos Text, both free from Google Fonts.
- **Colours:** Beet red, leaf green, mint white. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/health-fitness/nutritionist/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: nutritionist website template, dietitian HTML template free, meal plan website template, free HTML template, one page website template, responsive website template download</sub>

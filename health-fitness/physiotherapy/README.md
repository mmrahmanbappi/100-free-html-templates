# Straightline Physio: Free Physiotherapy Website Template (HTML)

A bold physio clinic in indigo and orange. Tap a spot on the body map to see common problems, usual sessions and recovery time, then book for that area.

![Straightline Physio, a free physiotherapy website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/health-fitness/physiotherapy/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with key facts
- Clickable body area picker
- Conditions and recovery details per area
- How it works
- Price table
- Booking form with FAQ

## Fonts and colours

- **Fonts:** Asap Condensed + Asap, both free from Google Fonts.
- **Colours:** Indigo, orange, pale blue. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/health-fitness/physiotherapy/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: physiotherapy website template, physio clinic HTML template free, physical therapy website template, free HTML template, one page website template, responsive website template download</sub>

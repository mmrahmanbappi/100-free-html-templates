# Dara Mensah: Free Personal Trainer Website Template (HTML)

A bold personal trainer site in navy and coral. A three-question quiz picks the right programme, client stories flip between week 1 and final week numbers, and booking has time slots.

![Dara Mensah, a free personal trainer website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/health-fitness/personal-trainer/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Big italic type hero
- Programme finder quiz
- Programme cards
- Client progress stories with before and after numbers
- Consult booking with time slots

## Fonts and colours

- **Fonts:** Kanit + Inclusive Sans, both free from Google Fonts.
- **Colours:** Navy, coral, sky blue. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/health-fitness/personal-trainer/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: personal trainer website template, fitness coach HTML template free, PT website template, free HTML template, one page website template, responsive website template download</sub>

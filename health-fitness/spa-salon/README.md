# Alma Spa: Free Spa and Salon Website Template (HTML)

A warm rosewood spa and salon. Add massages, facials, hair and nails to one visit and see the total time and price, then design a gift voucher and watch the card update.

![Alma Spa, a free spa and salon website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/health-fitness/spa-salon/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Arched split hero
- Treatment menu with tabs and durations
- Visit basket with total time and price
- Booking form
- Gift voucher builder with live preview
- Visit us

## Fonts and colours

- **Fonts:** Forum + Raleway, both free from Google Fonts.
- **Colours:** Rosewood, blush, olive grey. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/health-fitness/spa-salon/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: spa website template, beauty salon HTML template free, massage spa website template, free HTML template, one page website template, responsive website template download</sub>

# Parkside Family Clinic: Free Medical Clinic Website Template (HTML)

A calm family doctor's clinic. It shows if the clinic is open right now and when it opens next, doctors filter by specialty, and each doctor card fills in the booking form.

![Parkside Family Clinic, a free medical clinic website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/health-fitness/medical-clinic/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with quick actions and open now status
- Services
- Doctor profiles with specialty filter
- Opening hours with today highlighted
- Appointment request form

## Fonts and colours

- **Fonts:** Merriweather + Merriweather Sans, both free from Google Fonts.
- **Colours:** Pine green, warm white, soft blue, red. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/health-fitness/medical-clinic/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: medical clinic website template, doctor HTML template free, healthcare website template, free HTML template, one page website template, responsive website template download</sub>

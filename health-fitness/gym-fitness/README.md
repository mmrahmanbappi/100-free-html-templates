# Foundry Strength Club: Free Gym and Fitness Website Template (HTML)

A loud strength gym site in cobalt and chalk. Switch days on the class timetable and book a spot, flip membership prices to yearly, and check your BMI on a live scale.

![Foundry Strength Club, a free gym and fitness website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/health-fitness/gym-fitness/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Full-bleed photo hero with huge type
- Key facts band
- Class timetable with day tabs and booking
- Membership plans with monthly and yearly toggle
- BMI calculator with colour scale
- Coaches

## Fonts and colours

- **Fonts:** Big Shoulders Display + Libre Franklin, both free from Google Fonts.
- **Colours:** Cobalt blue, chalk white, black. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/health-fitness/gym-fitness/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: gym website template, fitness HTML template free, gym class timetable template, free HTML template, one page website template, responsive website template download</sub>

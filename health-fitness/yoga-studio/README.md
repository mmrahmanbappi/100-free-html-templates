# Slow Tide Yoga: Free Yoga Studio Website Template (HTML)

A soft sea-glass yoga studio. The hero is a one-minute guided breathing timer, the weekly schedule filters by level, and a four-week path helps total beginners start.

![Slow Tide Yoga, a free yoga studio website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/health-fitness/yoga-studio/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with guided breathing timer
- Weekly class schedule with level filter
- Beginner path
- Class passes and prices
- Visit us

## Fonts and colours

- **Fonts:** Bellefair + Commissioner, both free from Google Fonts.
- **Colours:** Deep teal, sea glass, sand, saffron. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/health-fitness/yoga-studio/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: yoga studio website template, yoga HTML template free, yoga class schedule template, free HTML template, one page website template, responsive website template download</sub>

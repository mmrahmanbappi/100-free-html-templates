# Carepoint: Free Hospital Management Dashboard Website Template (HTML)

A calm, clinical hospital operations dashboard. It shows bed occupancy by ward with colour warnings, an emergency queue by triage level with live wait times, appointments with status filters, admissions and doctors on duty.

![Carepoint, a free hospital management dashboard website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/admin-dashboard/hospital-management/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Sidebar with emergency line
- 5 hospital KPI cards
- Bed occupancy by ward
- Emergency queue with triage colours and wait times
- Appointments table with status filters
- Admissions line chart
- Doctors on duty

## Fonts and colours

- **Fonts:** Noto Sans, both free from Google Fonts.
- **Colours:** Clinical teal, red, white. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/admin-dashboard/hospital-management/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: hospital management dashboard template, hospital admin panel HTML free, clinic dashboard template, free HTML template, one page website template, responsive website template download</sub>

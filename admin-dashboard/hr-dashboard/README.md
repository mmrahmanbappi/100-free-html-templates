# Peoplebase: Free HR Dashboard Website Template (HTML)

A friendly HR and employee management dashboard. Leave requests can be approved or declined with one click, the staff directory has working search and department filters, plus headcount, attendance and hiring.

![Peoplebase, a free hr dashboard website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/admin-dashboard/hr-dashboard/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Leave requests with working approve and decline
- Employee directory with search and department filter
- Attendance donut
- Birthdays, work anniversaries and open roles

## Fonts and colours

- **Fonts:** Nunito, both free from Google Fonts.
- **Colours:** Violet, pink, mint, sun yellow. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/admin-dashboard/hr-dashboard/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: HR dashboard template, employee management dashboard HTML free, HRMS admin template, free HTML template, one page website template, responsive website template download</sub>

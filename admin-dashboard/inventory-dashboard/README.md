# Stockroom: Free Inventory Dashboard Website Template (HTML)

An industrial-style inventory and stock dashboard. The stock table has working search, category and status filters, plus + and − buttons that update stock status and reorder suggestions live. Also shows zones and shipments.

![Stockroom, a free inventory dashboard website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/admin-dashboard/inventory-dashboard/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Dark sidebar with warehouse info
- Stock KPI cards with live low-stock count
- Stock table with search, filters and quantity buttons
- Warehouse zone capacity
- Incoming shipments
- 14-day stock movement chart
- Reorder suggestions with Create PO buttons

## Fonts and colours

- **Fonts:** Chakra Petch + Source Sans 3, both free from Google Fonts.
- **Colours:** Black, safety yellow, white. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/admin-dashboard/inventory-dashboard/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: inventory dashboard template, stock management dashboard HTML free, warehouse dashboard template, free HTML template, one page website template, responsive website template download</sub>

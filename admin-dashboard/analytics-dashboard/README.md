# Lookout: Free Analytics Dashboard Website Template (HTML)

A clean website analytics dashboard with a dark sidebar. KPI cards with sparklines, a visitors line chart that changes with the 7, 30 and 90 day buttons, traffic sources, devices donut, top pages and live visitors.

![Lookout, a free analytics dashboard website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/admin-dashboard/analytics-dashboard/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Sidebar navigation
- Top bar with search and date range buttons
- 4 KPI cards with sparklines
- Visitors line chart (this vs previous period)
- Traffic sources bars
- Top pages table
- Devices donut chart
- Live visitors counter and top countries

## Fonts and colours

- **Fonts:** Outfit, both free from Google Fonts.
- **Colours:** Teal, dark navy, amber. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/admin-dashboard/analytics-dashboard/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: analytics dashboard template, admin dashboard HTML template free, dashboard template with charts, free HTML template, one page website template, responsive website template download</sub>

# Taskwise: Free Project Management Dashboard Website Template (HTML)

A dark project management dashboard with a Gantt timeline showing workstreams and a launch milestone. Ticking sprint tasks updates the progress numbers live, with a burndown chart and team workload bars.

![Taskwise, a free project management dashboard website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/admin-dashboard/project-management/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Progress, tasks, budget and launch cards
- 8-week Gantt timeline with today marker
- Sprint burndown chart
- Task checklist that updates progress
- Team workload with over-capacity warning

## Fonts and colours

- **Fonts:** Geist, both free from Google Fonts.
- **Colours:** Charcoal, amber, blue, green. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/admin-dashboard/project-management/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: project management dashboard template, gantt chart HTML template free, project tracker dashboard, free HTML template, one page website template, responsive website template download</sub>

# Orbit Admin: Free SaaS Admin Panel Website Template (HTML)

A dark admin panel for a SaaS product with a light mode switch. It has an MRR area chart, customers by plan, system health, a users table with working search and filters, settings toggles and an audit log.

![Orbit Admin, a free saas admin panel website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/admin-dashboard/saas-admin-panel/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Sidebar with sections and counts
- Dark and light mode switch
- Business KPI cards
- MRR area chart
- Customers by plan and system health
- Users table with search, plan and status filters
- Settings toggle switches
- Audit log

## Fonts and colours

- **Fonts:** Be Vietnam Pro, both free from Google Fonts.
- **Colours:** Near-black, blue, peach. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/admin-dashboard/saas-admin-panel/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: SaaS admin panel template, admin dashboard template dark mode free, user management dashboard HTML, free HTML template, one page website template, responsive website template download</sub>

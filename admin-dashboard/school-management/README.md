# Classio: Free School Management Dashboard Website Template (HTML)

An easy-to-read school management dashboard using an extra-legible font. It shows attendance by grade with day buttons, fee collection progress, a class timetable, upcoming exams, top students and a notice board.

![Classio, a free school management dashboard website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/admin-dashboard/school-management/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Blue sidebar with term progress
- School KPI cards
- Attendance by grade bar chart with day switch
- Fee collection progress
- Today's class timetable
- Upcoming exams and top students
- Notice board

## Fonts and colours

- **Fonts:** Atkinson Hyperlegible, both free from Google Fonts.
- **Colours:** School blue, yellow, white. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/admin-dashboard/school-management/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: school management dashboard template, school admin panel HTML free, education dashboard template, free HTML template, one page website template, responsive website template download</sub>

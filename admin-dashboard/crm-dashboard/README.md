# Dealflow: Free CRM Dashboard Website Template (HTML)

A sales and CRM dashboard with an icon sidebar. The deal pipeline is a working drag and drop board that updates stage totals, plus a quarter target gauge, team leaderboard, task checklist and activity feed.

![Dealflow, a free crm dashboard website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/admin-dashboard/crm-dashboard/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Icon sidebar
- Sales KPI cards
- Drag and drop deal pipeline (keyboard friendly)
- Quarter target gauge
- Team leaderboard
...
- **Fonts:** Rubik, both free from Google Fonts.
- **Colours:** Navy, green, soft grey. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/admin-dashboard/crm-dashboard/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: CRM dashboard template, sales dashboard HTML template free, deal pipeline kanban template, free HTML template, one page website template, responsive website template download</sub>

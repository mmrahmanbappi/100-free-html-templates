# Shopdeck: Free E-commerce Admin Dashboard Website Template (HTML)

A friendly admin dashboard for an online store. It has sales cards, a revenue bar chart with 12 month and weekly views, a monthly goal ring, an orders table with working status filters, best sellers, low stock and reviews.
...
- Sidebar with order count
- Sales KPI cards
- Revenue bar chart with period switch
- Monthly goal ring
- Orders table with status filter buttons
- Best-selling products with photos
- Low stock alerts
- Latest reviews

## Fonts and colours

- **Fonts:** Plus Jakarta Sans, both free from Google Fonts.
- **Colours:** Orange, warm white, stone. You can change every colour in the `:root` section at the top of the `<style>` block.
...
<sub>Search terms: ecommerce admin dashboard template, online store admin panel HTML free, shop dashboard template, free HTML template, one page website template, responsive website template download</sub>

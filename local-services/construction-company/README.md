# Stonebridge Build: Free Construction Company Website Template (HTML)

A solid construction company site in steel blue, concrete and safety yellow. A live safety counter, projects filtered by type, and a quote form with a budget slider.

![Stonebridge Build, a free construction company website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/local-services/construction-company/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Full-bleed site photo hero
- Safety record counter
...
- **Fonts:** Oswald + Barlow Semi Condensed, both free from Google Fonts.
- **Colours:** Steel blue, concrete, safety yellow. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/local-services/construction-company/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: construction company website template, builder HTML template free, contractor website template, free HTML template, one page website template, responsive website template download</sub>

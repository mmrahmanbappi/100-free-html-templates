# Hartley & Okafor: Free Law Firm Website Template (HTML)

A trustworthy law firm in oxblood and stone with a classic serif. Pick a practice area to see what's included and typical fees, filter lawyers by area and book a free call.
...
- Split hero with key numbers
- Practice area tabs with fees
- Lawyers with area filter
- Case results
- Free consultation form

## Fonts and colours

- **Fonts:** Castoro + Libre Franklin, both free from Google Fonts.
- **Colours:** Oxblood, navy, stone. You can change every colour in the `:root` section at the top of the `<style>` block.
...
<sub>Search terms: law firm website template, lawyer HTML template free, solicitor website template, free HTML template, one page website template, responsive website template download</sub>

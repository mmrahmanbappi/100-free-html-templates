# Fresh Nest Cleaning: Free Cleaning Company Website Template (HTML)

A fresh cleaning company site in mint and sky blue. Set bedrooms, bathrooms, clean type, frequency and extras, and the price per clean updates before you book.

![Fresh Nest Cleaning, a free cleaning company website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/local-services/cleaning-company/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with photo pair
- Cleaning types
- Price calculator with bedrooms, bathrooms, frequency and extras
- Booking form
- Reviews

## Fonts and colours

- **Fonts:** Comfortaa + Open Sans, both free from Google Fonts.
- **Colours:** Mint, sky blue, navy. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/local-services/cleaning-company/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: cleaning company website template, house cleaning HTML template free, cleaning service website, free HTML template, one page website template, responsive website template download</sub>

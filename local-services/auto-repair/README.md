# Torque Street Garage: Free Auto Repair Website Template (HTML)

A workshop-tough garage site in racing blue and hazard yellow. Fixed prices for common jobs, and the booking form updates the estimate for your car size and age.

![Torque Street Garage, a free auto repair website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/local-services/auto-repair/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with open now status
- Fixed price list
- Booking with car size, model and year
- Live estimate
- Reviews

## Fonts and colours

- **Fonts:** Teko + Work Sans, both free from Google Fonts.
- **Colours:** Racing blue, hazard yellow, concrete. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/local-services/auto-repair/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: auto repair website template, car garage HTML template free, mechanic website template, free HTML template, one page website template, responsive website template download</sub>

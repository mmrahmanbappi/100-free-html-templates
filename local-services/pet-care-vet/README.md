# Paws & Whiskers Vets: Free Vet and Pet Care Website Template (HTML)

A warm, rounded vet site in orange and sage. Pick dog, cat or rabbit to see services and prices, work out when jabs are due and add reminders to your calendar.

![Paws & Whiskers Vets, a free vet and pet care website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/local-services/pet-care-vet/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Emergency bar
- Blob photo hero
- Pet type picker with services and prices
- Vaccination reminder with calendar file
- Appointment form

## Fonts and colours

- **Fonts:** Sniglet + Nunito, both free from Google Fonts.
- **Colours:** Warm orange, sage green, pale blue. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/local-services/pet-care-vet/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: vet clinic website template, veterinary HTML template free, pet care website template, free HTML template, one page website template, responsive website template download</sub>

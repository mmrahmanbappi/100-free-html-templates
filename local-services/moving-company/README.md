# Two Hands Removals: Free Moving Company Website Template (HTML)

A friendly removals site in cardboard brown and navy with drawn boxes. The move calculator suggests a van, crew, hours and price, and the packing checklist tracks progress by week.

![Two Hands Removals, a free moving company website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/local-services/moving-company/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with drawn boxes and van
- Move size calculator
- Fixed quote form
- Packing checklist by week with progress bar

## Fonts and colours

- **Fonts:** Passion One + Karla, both free from Google Fonts.
- **Colours:** Cardboard brown, navy, kraft. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/local-services/moving-company/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: moving company website template, removals HTML template free, movers website template, free HTML template, one page website template, responsive website template download</sub>

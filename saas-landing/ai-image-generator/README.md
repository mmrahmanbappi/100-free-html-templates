# Prismo: Free AI Image Generator Website Template (HTML)

A dark, colourful landing page for an AI image or video generator. It has a working prompt box with example prompts, a generated image grid, tools, a masonry gallery, credit-based pricing and FAQ.

![Prismo, a free ai image generator website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/saas-landing/ai-image-generator/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with prompt box and example prompt buttons
- Generated image grid
- Key numbers
- 4 tool cards
- Masonry gallery with prompts
- 3-step how it works
- Credit-based pricing
- Customer quote
- FAQ about usage rights
- Image-backed final call to action

## Fonts and colours

- **Fonts:** Red Hat Display + Red Hat Text, both free from Google Fonts.
- **Colours:** Night blue, hot pink, cyan. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/saas-landing/ai-image-generator/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: AI image generator landing page template, AI art website template free, AI video generator HTML template, free HTML template, one page website template, responsive website template download</sub>

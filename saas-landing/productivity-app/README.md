# Stillday: Free Productivity App Website Template (HTML)

A calm, friendly landing page for a planner, to-do or notes app. The hero shows a full day plan built in HTML, with a 3-step method, feature sections, results, reviews, pricing and FAQ.

![Stillday, a free productivity app website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/saas-landing/productivity-app/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with day planner preview
- Customer strip
- 3-step method cards
- 2 feature rows with images
- Results band
- Reviews
- 3 pricing plans
- FAQ
...
- **Fonts:** Young Serif + Instrument Sans, both free from Google Fonts.
- **Colours:** Ink navy, coral, lavender white, teal. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/saas-landing/productivity-app/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: productivity app landing page template, planner app website template free, to do app landing page HTML, free HTML template, one page website template, responsive website template download</sub>

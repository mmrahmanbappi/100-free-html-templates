# The Sunday Sum: Free Newsletter and Waitlist Website Template (HTML)

A warm, readable landing page for an email newsletter or product waitlist. It has a signup box, a sample issue preview, reader numbers, past issues, an author section, referral rewards and FAQ.

![The Sunday Sum, a free newsletter and waitlist website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/saas-landing/newsletter-waitlist/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with email signup and sample issue
- Reader numbers
...
- **Fonts:** Fraunces + Work Sans, both free from Google Fonts.
- **Colours:** Plum, peach, rose. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/saas-landing/newsletter-waitlist/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: newsletter landing page template, waitlist page template free, email signup landing page HTML, free HTML template, one page website template, responsive website template download</sub>

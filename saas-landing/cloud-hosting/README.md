# Nimbus Cloud: Free Cloud Hosting Website Template (HTML)

A bright landing page for a cloud hosting or VPS company. The hero has a working server price calculator with sliders, followed by products, data centre regions, server plans, reviews and FAQ.

![Nimbus Cloud, a free cloud hosting website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/saas-landing/cloud-hosting/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with server price calculator
- Key numbers
- 4 product cards
- Hardware section with image
- Regions map and latency list
- 4 server plans
- Customer quotes
- FAQ
- Call to action
...
- **Fonts:** Sora, both free from Google Fonts.
- **Colours:** Deep blue, sky blue, orange. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/saas-landing/cloud-hosting/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: cloud hosting website template, web hosting template free, VPS hosting HTML template, free HTML template, one page website template, responsive website template download</sub>

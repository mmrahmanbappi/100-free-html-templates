# Bastion: Free Cyber Security Website Template (HTML)

A strong, serious website for a cyber security company. It has an emergency hotline bar, threat numbers, services, a working 1-minute security self-check with score, incident timeline, packages and FAQ.

![Bastion, a free cyber security website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/saas-landing/cyber-security/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with certifications
- Threat numbers
- 6 service cards
- Interactive security self-check with score
- Incident response timeline
- Client story with results
- 3 packages
- FAQ
- Contact form with hotline

## Fonts and colours

- **Fonts:** Barlow Condensed + Barlow, both free from Google Fonts.
- **Colours:** Navy, signal red, steel grey. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/saas-landing/cyber-security/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: cyber security website template, cybersecurity company template free, security services HTML template, free HTML template, one page website template, responsive website template download</sub>

# Mira: Free AI Chatbot Website Template (HTML)

A bright, friendly landing page for an AI chatbot or AI tool. The hero shows a live chat demo, followed by features, 3-step setup with install code, integrations, use cases, pricing, data safety and FAQ.

![Mira, a free ai chatbot website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/saas-landing/ai-chatbot/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with animated chat demo
- Customer strip
- Key numbers
- 6 feature cards
- 3-step setup with code snippet
- Integrations
...
- **Fonts:** Onest, both free from Google Fonts.
- **Colours:** Ink, bright blue, sky blue, sun yellow. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/saas-landing/ai-chatbot/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: AI chatbot landing page template, AI tool website template free, AI SaaS landing page HTML, free HTML template, one page website template, responsive website template download</sub>

# Habitly: Free Mobile App Website Template (HTML)

A cheerful landing page for a mobile app. Two phone mockups built in HTML show real app screens, with app store buttons, features, reviews, free and premium plans, FAQ and a QR code download box.

![Habitly, a free mobile app website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/saas-landing/mobile-app/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with 2 phone screen mockups and store buttons
- Press strip
- 6 colourful feature cards
- Image and benefits section
- App store reviews
- Free and premium plans
- FAQ
- Download box with QR code

## Fonts and colours

- **Fonts:** Urbanist, both free from Google Fonts.
- **Colours:** Tangerine, navy, butter yellow, mint. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/saas-landing/mobile-app/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: mobile app landing page template, app website template free, app landing page HTML, free HTML template, one page website template, responsive website template download</sub>

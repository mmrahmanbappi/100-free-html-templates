# Tabnook: Free Chrome Extension Website Template (HTML)

A bold, playful landing page for a browser extension. A browser window built in HTML shows the extension popup, with features, a before and after comparison, install steps, reviews, plans and FAQ.

![Tabnook, a free chrome extension website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/saas-landing/chrome-extension/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with browser and extension popup preview
- Press strip
- 6 feature cards
...
- Free and Pro plans
- FAQ
- Final install call to action

## Fonts and colours

- **Fonts:** Chivo, both free from Google Fonts.
- **Colours:** Yellow, black, white. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/saas-landing/chrome-extension/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: chrome extension landing page template, browser extension website template free, extension landing page HTML, free HTML template, one page website template, responsive website template download</sub>

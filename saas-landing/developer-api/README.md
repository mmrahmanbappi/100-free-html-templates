# Sendwell: Free Developer Tool and API Website Template (HTML)

A clean landing page for an API or developer tool. It has code examples with working Node.js, Python and cURL tabs, a copy-to-clipboard install command, uptime bars, SDK list, usage pricing and FAQ.

![Sendwell, a free developer tool and api website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/saas-landing/developer-api/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with tabbed code examples
- Install command with copy button
- Customer strip
- 6 feature grid
- Reliability numbers and 90-day uptime bars
- SDKs and languages
- Usage-based pricing
- Developer quote
- FAQ
...
- **Fonts:** IBM Plex Sans + IBM Plex Mono, both free from Google Fonts.
- **Colours:** Graphite, violet, green. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/saas-landing/developer-api/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: API landing page template, developer tool website template free, dev tool landing page HTML, free HTML template, one page website template, responsive website template download</sub>

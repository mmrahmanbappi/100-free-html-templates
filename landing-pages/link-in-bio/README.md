# Rosa Mendes Ceramics: Free Link in Bio Website Template (HTML)

A mobile-first link page for a ceramicist in glaze teal and mustard. Profile, link buttons, a countdown to the next shop drop, email signup, copy and share buttons, and a dark mode switch.

![Rosa Mendes Ceramics, a free link in bio website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/landing-pages/link-in-bio/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Profile with avatar and socials
- Next drop card with countdown
- Link buttons
- Email signup
...
- **Fonts:** Pacifico + DM Sans, both free from Google Fonts.
- **Colours:** Glaze teal, mustard, warm grey. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/landing-pages/link-in-bio/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: link in bio template, bio link page HTML free, creator links page, free HTML template, one page website template, responsive website template download</sub>

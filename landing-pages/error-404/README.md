# Paper Moon Books: Free 404 Error Page Website Template (HTML)

A playful 404 page for a bookshop in sky blue and pink. A floating book illustration, a search box that filters helpful links as you type, and a random book suggestion.

![Paper Moon Books, a free 404 error page website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/landing-pages/error-404/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- **Fonts:** Chango + Nunito, both free from Google Fonts.
- **Colours:** Sky blue, pink, ink. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/landing-pages/error-404/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: 404 page template, error page HTML template free, page not found template, free HTML template, one page website template, responsive website template download</sub>

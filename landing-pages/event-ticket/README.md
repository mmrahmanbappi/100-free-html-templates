# Night Market Live: Free Event Ticket Website Template (HTML)

A neon single-night event page in deep purple, pink and cyan. Count down to doors, see the line-up, pick ticket quantities across tiers with limits, try a promo code and watch the total with fees.

![Night Market Live, a free event ticket website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/landing-pages/event-ticket/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Full-bleed photo hero with countdown
- Line-up
- Ticket tiers with quantity limits and sold out
- Promo code
...
- **Fonts:** Monoton + Golos Text, both free from Google Fonts.
- **Colours:** Deep purple, neon pink, cyan. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/landing-pages/event-ticket/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: event ticket page template, concert landing page HTML free, ticket sales page, free HTML template, one page website template, responsive website template download</sub>

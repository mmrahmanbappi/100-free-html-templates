# Nookery: Free Coming Soon Website Template (HTML)

A warm coming soon page in forest green and peach. It counts down to launch, shows your place in the waitlist after you sign up, and lets visitors tap through a sneak peek of the products.

![Nookery, a free coming soon website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/landing-pages/coming-soon/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Waitlist signup with your place in line
- Sneak peek product picker
- Social links

## Fonts and colours

- **Fonts:** Abril Fatface + Figtree, both free from Google Fonts.
- **Colours:** Forest green, peach. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/landing-pages/coming-soon/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: coming soon page template, launch page HTML template free, waitlist landing page template, free HTML template, one page website template, responsive website template download</sub>

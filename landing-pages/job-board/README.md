# Hireloop: Free Job Board Website Template (HTML)

A clean job board in bright blue and amber. Search and filter jobs by location, type, salary and remote, open any job in the detail panel, save it and apply.

![Hireloop, a free job board website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/landing-pages/job-board/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Remote only and saved jobs
- Job list with salary on every post
- Job detail panel
- Apply form
- Post a job banner
...
- **Fonts:** Geologica, both free from Google Fonts.
- **Colours:** Bright blue, amber, slate. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/landing-pages/job-board/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: job board template, job listing website HTML free, careers page template, free HTML template, one page website template, responsive website template download</sub>

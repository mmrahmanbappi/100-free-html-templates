# Lumo Desk Lamp: Free Product Launch Website Template (HTML)

A calm hardware launch page in sage, graphite and amber. Drag the colour and brightness sliders to light up the drawn lamp, switch its finish, tap through features and reserve an early bird unit.

![Lumo Desk Lamp, a free product launch website template](screenshot.png)

**[See the live demo and download it free](https://mmrahmanbappi.github.io/100-free-html-templates/landing-pages/product-launch/)** &nbsp;|&nbsp; [More free templates](https://mmrahmanbappi.github.io/100-free-html-templates/)
...
- Hero with launch countdown
- Interactive lamp demo with colour, brightness and finish
- Feature tabs
- Early bird offer with stock bar
- Reserve form

## Fonts and colours

- **Fonts:** Tomorrow + Plus Jakarta Sans, both free from Google Fonts.
- **Colours:** Sage, graphite, amber. You can change every colour in the `:root` section at the top of the `<style>` block.

## How to make it yours

1. Open the [live demo](https://mmrahmanbappi.github.io/100-free-html-templates/landing-pages/product-launch/) and click **Download this template (free)** in the black bar at the top.
...
<sub>Search terms: product launch page template, product landing page HTML free, pre-order page template, free HTML template, one page website template, responsive website template download</sub>
